...
// ── Prompt role grouping ─────────────────────────────────────────────────────
// Inlined instead of importing from @signalkit/shared to keep this hotfix
// scoped to apps/web only. Mirrors packages/shared/src/product-pack.ts
// exactly; if that package gains this export in a later change, this local
// copy should be deleted in favor of the shared one.

type PromptRole = 'frontend' | 'backend' | 'ai' | 'qa' | 'integration' | 'general';

function inferPromptRole(relatedSections: readonly string[]): PromptRole {
